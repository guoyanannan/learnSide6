...
################################################################################
## Form generated from reading UI file 'everyClassDetail.ui'
##
...
class Ui_FormCreateEachCls(object):
    def setupUi(self, FormCreateEachCls):
        if not FormCreateEachCls.objectName():
            FormCreateEachCls.setObjectName(u"FormCreateEachCls")
        FormCreateEachCls.resize(1018, 853)
        self.groupBoxStateSL = QGroupBox(FormCreateEachCls)
        self.groupBoxStateSL.setObjectName(u"groupBoxStateSL")
        self.groupBoxStateSL.setGeometry(QRect(9, 30, 969, 778))
...
"")
        ...
        self.lineEditOneOneEdgeNum = QLineEdit(self.groupBoxSteelL1)
        self.lineEditOneOneEdgeNum.setObjectName(u"lineEditOneOneEdgeNum")
        self.lineEditOneOneEdgeNum.setReadOnly(True)

        self.gridLayout.addWidget(self.lineEditOneOneEdgeNum, 0, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEditOneThMin, 2, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEditOneThNo, 2, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEditOneOneMin, 0, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEditOneThMax, 2, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEditOneTwoNo, 1, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEditOneOneMax, 0, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEditOneTwoMax, 1, 9, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEditOneOneNo, 0, 11, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEditOneTwoMin, 1, 7, 1, 1)

        self.lineEditOneTwoEdgeNum = QLineEdit(self.groupBoxSteelL1)
        self.lineEditOneTwoEdgeNum.setObjectName(u"lineEditOneTwoEdgeNum")
        self.lineEditOneTwoEdgeNum.setReadOnly(True)

        self.gridLayout.addWidget(self.lineEditOneTwoEdgeNum, 1, 5, 1, 1)

        self.lineEditOneThEdgeNum = QLineEdit(self.groupBoxSteelL1)
        self.lineEditOneThEdgeNum.setObjectName(u"lineEditOneThEdgeNum")
        self.lineEditOneThEdgeNum.setReadOnly(True)

        self.gridLayout.addWidget(self.lineEditOneThEdgeNum, 2, 5, 1, 1)
...
"")
        ...
        self.lineEditTwoThMax = QLineEdit(self.groupBoxSteelL2)
        self.lineEditTwoThMax.setObjectName(u"lineEditTwoThMax")
        self.lineEditTwoThMax.setReadOnly(True)

        self.gridLayout_3.addWidget(self.lineEditTwoThMax, 2, 8, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lineEditTwoTwoMax, 1, 8, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lineEditTwoTwoNo, 1, 10, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_39, 1, 7, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lineEditTwoThMin, 2, 6, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_45, 2, 9, 1, 1)

        self.label_33 = QLabel(self.groupBoxSteelL2)
        self.label_33.setObjectName(u"label_33")

        self.gridLayout_3.addWidget(self.label_33, 2, 7, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lineEditTwoOneMax, 0, 8, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lineEditTwoThNo, 2, 10, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lineEditTwoTwoMin, 1, 6, 1, 1)

        self.label_36 = QLabel(self.groupBoxSteelL2)
        self.label_36.setObjectName(u"label_36")

        self.gridLayout_3.addWidget(self.label_36, 0, 7, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lineEditTwoOneMin, 0, 6, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lineEditTwoOneNo, 0, 10, 1, 1)

        self.label_43 = QLabel(self.groupBoxSteelL2)
        self.label_43.setObjectName(u"label_43")

        self.gridLayout_3.addWidget(self.label_43, 0, 9, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_44, 1, 9, 1, 1)

        self.label_38 = QLabel(self.groupBoxSteelL2)
        self.label_38.setObjectName(u"label_38")

        self.gridLayout_3.addWidget(self.label_38, 2, 5, 1, 1)
        ...
        self.lineEditTwoOneEdgeNum = QLineEdit(self.groupBoxSteelL2)
        self.lineEditTwoOneEdgeNum.setObjectName(u"lineEditTwoOneEdgeNum")
        self.lineEditTwoOneEdgeNum.setReadOnly(True)

        self.gridLayout_3.addWidget(self.lineEditTwoOneEdgeNum, 0, 4, 1, 1)

        self.lineEditTwoTwoEdgeNum = QLineEdit(self.groupBoxSteelL2)
        self.lineEditTwoTwoEdgeNum.setObjectName(u"lineEditTwoTwoEdgeNum")
        self.lineEditTwoTwoEdgeNum.setReadOnly(True)

        self.gridLayout_3.addWidget(self.lineEditTwoTwoEdgeNum, 1, 4, 1, 1)

        self.lineEditTwoThEdgeNum = QLineEdit(self.groupBoxSteelL2)
        self.lineEditTwoThEdgeNum.setObjectName(u"lineEditTwoThEdgeNum")
        self.lineEditTwoThEdgeNum.setReadOnly(True)

        self.gridLayout_3.addWidget(self.lineEditTwoThEdgeNum, 2, 4, 1, 1)
...
"")
        ...
        self.gridLayout_4.addWidget(self.lineEditThOneMax, 0, 8, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.label_54, 1, 7, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lineEditThThMax, 2, 8, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lineEditThOneMin, 0, 6, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lineEditThTwoNo, 1, 10, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lineEditThOneNo, 0, 10, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.label_60, 2, 9, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lineEditThThNo, 2, 10, 1, 1)

        self.label_52 = QLabel(self.groupBoxSteelL3)
        self.label_52.setObjectName(u"label_52")

        self.gridLayout_4.addWidget(self.label_52, 1, 5, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lineEditThTwoMin, 1, 6, 1, 1)

        self.label_53 = QLabel(self.groupBoxSteelL3)
        self.label_53.setObjectName(u"label_53")

        self.gridLayout_4.addWidget(self.label_53, 2, 5, 1, 1)

        self.label_51 = QLabel(self.groupBoxSteelL3)
        self.label_51.setObjectName(u"label_51")

        self.gridLayout_4.addWidget(self.label_51, 0, 7, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lineEditThThMin, 2, 6, 1, 1)

        self.label_48 = QLabel(self.groupBoxSteelL3)
        self.label_48.setObjectName(u"label_48")

        self.gridLayout_4.addWidget(self.label_48, 2, 7, 1, 1)

        self.label_57 = QLabel(self.groupBoxSteelL3)
        self.label_57.setObjectName(u"label_57")

        self.gridLayout_4.addWidget(self.label_57, 0, 5, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lineEditThTwoMax, 1, 8, 1, 1)
        ...
        self.lineEditThOneEdgeNum = QLineEdit(self.groupBoxSteelL3)
        self.lineEditThOneEdgeNum.setObjectName(u"lineEditThOneEdgeNum")
        self.lineEditThOneEdgeNum.setReadOnly(True)

        self.gridLayout_4.addWidget(self.lineEditThOneEdgeNum, 0, 4, 1, 1)

        self.lineEditThTwoEdgeNum = QLineEdit(self.groupBoxSteelL3)
        self.lineEditThTwoEdgeNum.setObjectName(u"lineEditThTwoEdgeNum")
        self.lineEditThTwoEdgeNum.setReadOnly(True)

        self.gridLayout_4.addWidget(self.lineEditThTwoEdgeNum, 1, 4, 1, 1)

        self.lineEditThThEdgeNum = QLineEdit(self.groupBoxSteelL3)
        self.lineEditThThEdgeNum.setObjectName(u"lineEditThThEdgeNum")
        self.lineEditThThEdgeNum.setReadOnly(True)

        self.gridLayout_4.addWidget(self.lineEditThThEdgeNum, 2, 4, 1, 1)
        ...
        self.checkBoxClassName = QCheckBox(FormCreateEachCls)
        self.checkBoxClassName.setObjectName(u"checkBoxClassName")
        self.checkBoxClassName.setEnabled(True)
        self.checkBoxClassName.setGeometry(QRect(9, 9, 58, 16))
        self.checkBoxClassName.setStyleSheet(u"QCheckBox{\n"
"	margin-left:15px;\n"
"}")
        self.checkBoxClassName.setChecked(False)

        self.retranslateUi(FormCreateEachCls)

        QMetaObject.connectSlotsByName(FormCreateEachCls)
    # setupUi

    def retranslateUi(self, FormCreateEachCls):
        FormCreateEachCls.setWindowTitle(QCoreApplication.translate("FormCreateEachCls", u"Form", None))
        self.groupBoxStateSL.setTitle("")
        self.groupBox.setTitle("")
        self.radioButtonSLevel.setText(QCoreApplication.translate("FormCreateEachCls", u"\u4e00\u7b49\u54c1", None))
        self.groupBoxSteelL1.setTitle("")
        self.label_3.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u8ddd\u533a\u95f4mm:", None))
        self.labelLevelNumber_3.setText(QCoreApplication.translate("FormCreateEachCls", u"\u7f3a\u9677\u7b49\u7ea7\u4e09", None))
        self.labelLevelNumber.setText(QCoreApplication.translate("FormCreateEachCls", u"\u7f3a\u9677\u7b49\u7ea7\u4e00:", None))
        self.label_13.setText(QCoreApplication.translate("FormCreateEachCls", u"\u5934\u5c3e\u5ffd\u7565mm", None))
        self.label_2.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u90e8\u6570\u91cf:", None))
        self.label_8.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u90e8\u6570\u91cf:", None))
        self.label_12.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u90e8\u6570\u91cf:", None))
        self.label_10.setText(QCoreApplication.translate("FormCreateEachCls", u"\u81f3", None))
        self.label_4.setText(QCoreApplication.translate("FormCreateEachCls", u"\u81f3", None))
        self.label_6.setText(QCoreApplication.translate("FormCreateEachCls", u"\u81f3", None))
        self.label_14.setText(QCoreApplication.translate("FormCreateEachCls", u"\u5934\u5c3e\u5ffd\u7565mm", None))
        self.label_15.setText(QCoreApplication.translate("FormCreateEachCls", u"\u5934\u5c3e\u5ffd\u7565mm", None))
        self.label_9.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u8ddd\u533a\u95f4mm:", None))
        self.label_5.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u8ddd\u533a\u95f4mm:", None))
        self.labelLevelNumber_2.setText(QCoreApplication.translate("FormCreateEachCls", u"\u7f3a\u9677\u7b49\u7ea7\u4e8c", None))
        self.label.setText(QCoreApplication.translate("FormCreateEachCls", u"\u6574\u4f53\u6570\u91cf:", None))
        self.label_11.setText(QCoreApplication.translate("FormCreateEachCls", u"\u6574\u4f53\u6570\u91cf:", None))
        self.label_7.setText(QCoreApplication.translate("FormCreateEachCls", u"\u6574\u4f53\u6570\u91cf:", None))
        self.groupBox_4.setTitle("")
        self.radioButtonSLevel_2.setText(QCoreApplication.translate("FormCreateEachCls", u"\u4e8c\u7b49\u54c1", None))
        self.groupBoxSteelL2.setTitle("")
        self.label_35.setText(QCoreApplication.translate("FormCreateEachCls", u"\u6574\u4f53\u6570\u91cf:", None))
        self.label_41.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u90e8\u6570\u91cf:", None))
        self.label_31.setText(QCoreApplication.translate("FormCreateEachCls", u"\u6574\u4f53\u6570\u91cf:", None))
        self.label_42.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u8ddd\u533a\u95f4mm:", None))
        self.label_32.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u90e8\u6570\u91cf:", None))
        self.labelLevelNumber_7.setText(QCoreApplication.translate("FormCreateEachCls", u"\u7f3a\u9677\u7b49\u7ea7\u4e09", None))
        self.label_39.setText(QCoreApplication.translate("FormCreateEachCls", u"\u81f3", None))
        self.label_40.setText(QCoreApplication.translate("FormCreateEachCls", u"\u6574\u4f53\u6570\u91cf:", None))
        self.label_37.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u8ddd\u533a\u95f4mm:", None))
        self.label_45.setText(QCoreApplication.translate("FormCreateEachCls", u"\u5934\u5c3e\u5ffd\u7565mm", None))
        self.label_33.setText(QCoreApplication.translate("FormCreateEachCls", u"\u81f3", None))
        self.label_34.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u90e8\u6570\u91cf:", None))
        self.label_36.setText(QCoreApplication.translate("FormCreateEachCls", u"\u81f3", None))
        self.label_43.setText(QCoreApplication.translate("FormCreateEachCls", u"\u5934\u5c3e\u5ffd\u7565mm", None))
        self.labelLevelNumber_9.setText(QCoreApplication.translate("FormCreateEachCls", u"\u7f3a\u9677\u7b49\u7ea7\u4e00:", None))
        self.label_44.setText(QCoreApplication.translate("FormCreateEachCls", u"\u5934\u5c3e\u5ffd\u7565mm", None))
        self.label_38.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u8ddd\u533a\u95f4mm:", None))
        self.labelLevelNumber_8.setText(QCoreApplication.translate("FormCreateEachCls", u"\u7f3a\u9677\u7b49\u7ea7\u4e8c", None))
        self.groupBox_7.setTitle("")
        self.radioButtonSLevel_3.setText(QCoreApplication.translate("FormCreateEachCls", u"\u4e09\u7b49\u54c1", None))
        self.groupBoxSteelL3.setTitle("")
        self.label_58.setText(QCoreApplication.translate("FormCreateEachCls", u"\u5934\u5c3e\u5ffd\u7565mm", None))
        self.label_46.setText(QCoreApplication.translate("FormCreateEachCls", u"\u6574\u4f53\u6570\u91cf:", None))
        self.label_47.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u90e8\u6570\u91cf:", None))
        self.label_54.setText(QCoreApplication.translate("FormCreateEachCls", u"\u81f3", None))
        self.label_49.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u90e8\u6570\u91cf:", None))
        self.labelLevelNumber_11.setText(QCoreApplication.translate("FormCreateEachCls", u"\u7f3a\u9677\u7b49\u7ea7\u4e8c", None))
        self.labelLevelNumber_10.setText(QCoreApplication.translate("FormCreateEachCls", u"\u7f3a\u9677\u7b49\u7ea7\u4e09", None))
        self.labelLevelNumber_12.setText(QCoreApplication.translate("FormCreateEachCls", u"\u7f3a\u9677\u7b49\u7ea7\u4e00:", None))
        self.label_55.setText(QCoreApplication.translate("FormCreateEachCls", u"\u6574\u4f53\u6570\u91cf:", None))
        self.label_59.setText(QCoreApplication.translate("FormCreateEachCls", u"\u5934\u5c3e\u5ffd\u7565mm", None))
        self.label_60.setText(QCoreApplication.translate("FormCreateEachCls", u"\u5934\u5c3e\u5ffd\u7565mm", None))
        self.label_52.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u8ddd\u533a\u95f4mm:", None))
        self.label_53.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u8ddd\u533a\u95f4mm:", None))
        self.label_51.setText(QCoreApplication.translate("FormCreateEachCls", u"\u81f3", None))
        self.label_56.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u90e8\u6570\u91cf:", None))
        self.label_48.setText(QCoreApplication.translate("FormCreateEachCls", u"\u81f3", None))
        self.label_57.setText(QCoreApplication.translate("FormCreateEachCls", u"\u8fb9\u8ddd\u533a\u95f4mm:", None))
        self.label_50.setText(QCoreApplication.translate("FormCreateEachCls", u"\u6574\u4f53\u6570\u91cf:", None))
        self.checkBoxClassName.setText(QCoreApplication.translate("FormCreateEachCls", u"\u5212\u4f24", None))
    # retranslateUi
